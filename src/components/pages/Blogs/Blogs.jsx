    ...
    return (
        <div className=' mt-10 p-5'>
            ...
            <div className="collapse collapse-plus bg-amber-100 mt-2">
                ...
                <div className="collapse-content">
                    <p>Node.js is an open source and cross-platform runtime environment for executing JavaScript code outside of a browser. You need to remember that NodeJS is not a framework and it's not a programming language. Most of the people are confused and understand it's a framework or a programming language. We often use Node.js for building back-end services like APIs like Web App or Mobile App. It's used in production by large companies such as Paypal, Uber, Netflix, Walmart and so on.C, C++, JavaScript.Run-time platform or environment designed for server-side execution of JavaScript.Express is a small framework that sits on top of Node.js's web server functionality to simplify its APIs and add helpful new features. It makes it easier to organize your application's functionality with middle ware and routing. It adds helpful utilities to Node.js's HTTP objects. It facilitates the rendering of dynamic HTTP objects. </p>
                </div>
            </div>
            <div className="collapse collapse-plus bg-amber-100 mt-2">
                <input type="radio" name="my-accordion-3" />
